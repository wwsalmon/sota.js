...
export function sotaNavbar(sotaConfig, text="", logo=false, textLink=false, logoLink = false){
...
export function createSections(sotaConfig){
    for (const section of sotaConfig.sections){
