...
export function setStyles(thisSotaConfig = sotaConfig){
...
export function setColors(sotaConfig){
    let colorStyle = "";
 ...
 */
export function colorInterpolate(start,end="#ffffff",steps=8, includeLast=false){
